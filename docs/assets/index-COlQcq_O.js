...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function X(e,t,n){let r=new Float32Array(Ua),i=new W(0,1,0);return new Ri({name:`SphericalGaussianBlur`,defines:{n:Ua,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ao(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ro(){return new Ri({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ao(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function io(){return new Ri({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ao(),fragmentShader:`
	...
	`}var oo=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ti(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;class oe{constructor(e){this.props=e||{},this.uniforms=this.props.material?.uniforms,this.scene=null,this.camera=null,this.material=null,this.geometry=null,this.plane=null}init(){this.scene=new Ln,this.camera=new aa,this.uniforms&&(this.material=new zi(this.props.material),this.geometry=new ki(2,2),this.plane=new ei(this.geometry,this.material),this.scene.add(this.plane))}update(){j.renderer.setRenderTarget(this.props.output||null),j.renderer.render(this.scene,this.camera),j.renderer.setRenderTarget(null)}}class se extends oe{constructor(e){super({material:{vertexShader:P,fragmentShader:ae,uniforms:{boundarySpace:{value:e.cellScale},px:{value:e.cellScale},fboSize:{value:e.fboSize},velocity:{value:e.src.texture},dt:{value:e.dt},isBFECC:{value:!0}}},output:e.dst}),this.uniforms=this.props.material.uniforms,this.init()}init(){super.init(),this.createBoundary()}createBoundary(){let e=new jr,t=new Float32Array([-1,-1,0,-1,1,0,-1,1,0,1,1,0,1,1,0,1,-1,0,1,-1,0,-1,-1,0]);e.setAttribute(`position`,new gr(t,3));let n=new zi({vertexShader:`
  attribute vec3 position;
  uniform vec2 px;
  precision highp float;
  varying vec2 uv;
...
`,fragmentShader:ae,uniforms:this.uniforms});this.line=new wi(e,n),this.scene.add(this.line)}update({dt:e,isBounce:t,BFECC:n}){this.uniforms.dt.value=e,this.line.visible=t,this.uniforms.isBFECC.value=n,super.update()}}class F extends oe{constructor(e){super({output:e.dst}),this.init(e)}init(e){super.init();let t=new ki(1,1),n=new zi({vertexShader:`
    precision highp float;
    attribute vec3 position;
    attribute vec2 uv;
    uniform vec2 center;
...
`,blending:2,depthWrite:!1,uniforms:{px:{value:e.cellScale},force:{value:new U(0,0)},center:{value:new U(0,0)},scale:{value:new U(e.cursor_size,e.cursor_size)}}});this.mouse=new ei(t,n),this.scene.add(this.mouse)}update(e){let t=M.diff.x/2*e.mouse_force,n=M.diff.y/2*e.mouse_force,r=e.cursor_size*e.cellScale.x,i=e.cursor_size*e.cellScale.y,a=Math.min(Math.max(M.coords.x,-1+r+e.cellScale.x*2),1-r-e.cellScale.x*2),o=Math.min(Math.max(M.coords.y,-1+i+e.cellScale.y*2),1-i-e.cellScale.y*2),s=this.mouse.material.uniforms;s.force.value.set(t,n),s.center.value.set(a,o),s.scale.value.set(e.cursor_size,e.cursor_size),super.update()}}class ce extends oe{constructor(e){super({material:{vertexShader:P,fragmentShader:`
    precision highp float;
    uniform sampler2D velocity;
...
`,uniforms:{boundarySpace:{value:e.boundarySpace},velocity:{value:e.src.texture},px:{value:e.cellScale},dt:{value:e.dt}}},output:e.dst}),this.init()}update({vel:e}){this.uniforms.velocity.value=e.texture,super.update()}}class ue extends oe{constructor(e){super({material:{vertexShader:P,fragmentShader:`
    precision highp float;
...
`,uniforms:{boundarySpace:{value:e.boundarySpace},pressure:{value:e.src_p.texture},velocity:{value:e.src_v.texture},px:{value:e.cellScale},dt:{value:e.dt}}},output:e.dst}),this.init()}update({vel:e,pressure:t}){this.uniforms.velocity.value=e.texture,this.uniforms.pressure.value=t.texture,super.update()}}class pe{constructor(e){this.options={iterations_poisson:32,iterations_viscous:32,mouse_force:20,resolution:.5,cursor_size:100,viscous:30,isBounce:!1,dt:.014,isViscous:!1,BFECC:!0,...e},this.fbos={vel_0:null,vel_1:null,vel_viscous0:null,vel_viscous1:null,div:null,pressure_0:null,pressure_1:null},this.fboSize=new U,this.cellScale=new U,this.boundarySpace=new U,this.init()}init(){this.calcSize(),this.createAllFBO(),this.createShaderPass()}getFloatType(){return/(iPad|iPhone|iPod)/i.test(navigator.userAgent)?ie:re}createAllFBO(){let e={type:this.getFloatType(),depthBuffer:!1,stencilBuffer:!1,minFilter:k,magFilter:k,wrapS:w,wrapT:w};for(let t in this.fbos)this.fbos[t]=new Xt(this.fboSize.x,this.fboSize.y,e)}createShaderPass(){this.advection=new se({cellScale:this.cellScale,fboSize:this.fboSize,dt:this.options.dt,src:this.fbos.vel_0,dst:this.fbos.vel_1}),this.externalForce=new F({cellScale:this.cellScale,cursor_size:this.options.cursor_size,dst:this.fbos.vel_1}),this.viscous=new ce({cellScale:this.cellScale,boundarySpace:this.boundarySpace,viscous:this.options.viscous,src:this.fbos.vel_1,dst:this.fbos.vel_viscous1,dst_:this.fbos.vel_viscous0,dt:this.options.dt}),this.divergence=new le({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.vel_viscous0,dst:this.fbos.div,dt:this.options.dt}),this.poisson=new ue({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.div,dst:this.fbos.pressure_1,dst_:this.fbos.pressure_0}),this.pressure=new fe({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src_p:this.fbos.pressure_0,src_v:this.fbos.vel_viscous0,dst:this.fbos.vel_0,dt:this.options.dt})}calcSize(){let e=Math.max(1,Math.round(this.options.resolution*j.width)),t=Math.max(1,Math.round(this.options.resolution*j.height)),n=1/e,r=1/t;this.cellScale.set(n,r),this.fboSize.set(e,t)}resize(){this.calcSize();for(let e in this.fbos)this.fbos[e].setSize(this.fboSize.x,this.fboSize.y)}update(){this.options.isBounce?this.boundarySpace.set(0,0):this.boundarySpace.copy(this.cellScale),this.advection.update({dt:this.options.dt,isBounce:this.options.isBounce,BFECC:this.options.BFECC}),this.externalForce.update({cursor_size:this.options.cursor_size,mouse_force:this.options.mouse_force,cellScale:this.cellScale});let e=this.fbos.vel_1;this.options.isViscous&&(e=this.viscous.update({viscous:this.options.viscous,iterations:this.options.iterations_viscous,dt:this.options.dt})),this.divergence.update({vel:e});let t=this.poisson.update({iterations:this.options.iterations_poisson});this.pressure.update({vel:e,pressure:t})}}class me{constructor(){this.init()}init(){this.simulation=new pe,this.scene=new Ln,this.camera=new aa,this.output=new ei(new ki(2,2),new zi({vertexShader:P,fragmentShader:`
    precision highp float;
    uniform sampler2D velocity;
...
`,transparent:!0,depthWrite:!1,uniforms:{velocity:{value:this.simulation.fbos.vel_0.texture},boundarySpace:{value:new U},palette:{value:f},bgColor:{value:b},lightMode:{value:S}}})),this.scene.add(this.output)}addScene(e){this.scene.add(e)}resize(){this.simulation.resize()}render(){j.renderer.setRenderTarget(null),j.renderer.render(this.scene,this.camera)}update(){this.simulation.update(),this.render()}}class he{constructor(e){this.props=e,j.init(e.$wrapper),M.init(e.$wrapper),M.autoIntensity=e.autoIntensity,M.takeoverDuration=e.takeoverDuration,this.lastUserInteraction=performance.now(),M.onInteract=()=>{this.lastUserInteraction=performance.now(),this.autoDriver&&this.autoDriver.forceStop()},this.autoDriver=new N(M,this,{enabled:e.autoDemo,speed:e.autoSpeed,resumeDelay:e.autoResumeDelay,rampDuration:e.autoRampDuration}),this.init(),this._loop=this.loop.bind(this),this._resize=this.resize.bind(this),window.addEventListener(`resize`,this._resize),this._onVisibility=()=>{document.hidden?this.pause():A.current&&this.start()},document.addEventListener(`visibilitychange`,this._onVisibility),this.running=!1}init(){this.props.$wrapper.prepend(j.renderer.domElement),this.output=new me}resize(){j.resize(),this.output.resize()}render(){this.autoDriver&&this.autoDriver.update(),M.update(),j.update(),this.output.update()}loop(){this.running&&(this.render(),D.current=requestAnimationFrame(this._loop))}start(){this.running||(this.running=!0,this._loop())}pause(){this.running=!1,D.current&&=(cancelAnimationFrame(D.current),null)}dispose(){try{if(window.removeEventListener(`resize`,this._resize),document.removeEventListener(`visibilitychange`,this._onVisibility),M.dispose(),j.renderer){let e=j.renderer.domElement;e&&e.parentNode&&e.parentNode.removeChild(e),j.renderer.dispose(),j.renderer.forceContextLoss()}}catch{}}}let ge=C.current;ge.style.position=ge.style.position||`relative`,ge.style.overflow=ge.style.overflow||`hidden`;let _e=new he({$wrapper:ge,autoDemo:p,autoSpeed:m,autoIntensity:h,takeoverDuration:g,autoResumeDelay:v,autoRampDuration:y});T.current=_e,(()=>{if(!T.current)return;let u=T.current.output?.simulation;if(!u)return;let d=u.options.resolution;Object.assign(u.options,{mouse_force:e,cursor_size:t,isViscous:n,viscous:r,iterations_viscous:i,iterations_poisson:a,dt:o,BFECC:s,resolution:c,isBounce:l}),c!==d&&u.resize()})(),_e.start();let ve=new IntersectionObserver(e=>{let t=e[0],n=t.isIntersecting&&t.intersectionRatio>0;A.current=n,T.current&&(n&&!document.hidden?T.current.start():T.current.pause())},{threshold:[0,.01,.1]});ve.observe(ge),O.current=ve;let ye=new ResizeObserver(()=>{T.current&&(ee.current&&cancelAnimationFrame(ee.current),ee.current=requestAnimationFrame(()=>{T.current&&T.current.resize()}))});return ye.observe(ge),E.current=ye,()=>{if(D.current&&cancelAnimationFrame(D.current),E.current)try{E.current.disconnect()}catch{}if(O.current)try{O.current.disconnect()}catch{}T.current&&T.current.dispose(),T.current=null}},[s,t,o,l,n,a,i,e,c,r,u,p,m,h,g,v,y,x,S]),(0,_.useEffect)(()=>{let u=T.current;if(!u)return;let d=u.output?.simulation;if(!d)return;let f=d.options.resolution;Object.assign(d.options,{mouse_force:e,cursor_size:t,isViscous:n,viscous:r,iterations_viscous:i,iterations_poisson:a,dt:o,BFECC:s,resolution:c,isBounce:l}),u.autoDriver&&(u.autoDriver.enabled=p,u.autoDriver.speed=m,u.autoDriver.resumeDelay=v,u.autoDriver.rampDurationMs=y*1e3,u.autoDriver.mouse&&(u.autoDriver.mouse.autoIntensity=h,u.autoDriver.mouse.takeoverDuration=g)),c!==f&&d.resize()},[e,t,n,r,i,a,o,s,c,l,p,m,h,g,v,y]),(0,b.jsx)(`div`,{ref:C,className:`liquid-ether-container ${f||``}`,style:d})}function qc({children:e}){return(0,b.jsx)(b.Fragment,{children:e})}function Jc({onNavigate:e}){return(0,b.jsx)(b.Fragment,{children:(0,b.jsx)(`header`,{id:`hero`,className:`hero-section`,children:(0,b.jsxs)(`div`,{className:`hero-content`,children:[(0,b.jsx)(`div`,{className:`hero-icon`,children:(0,b.jsx)(`i`,{className:`bi bi-code-square`,"aria-hidden":`true`})}),(0,b.jsx)(`p`,{className:`hero-eyebrow`,children:`Hi, my name is`}),(0,b.jsx)(`h1`,{className:`hero-title`,children:`Prasoon Srivastava`}),(0,b.jsx)(`h2`,{className:`hero-subtitle`,children:`I build scalable software solutions.`}),(0,b.jsx)(`p`,{className:`hero-copy`,children:`I'm an aspiring software developer currently specializing in C# and backend systems.`}),(0,b.jsxs)(`div`,{className:`hero-actions`,children:[(0,b.jsx)(`button`,{onClick:t=>{t.preventDefault(),e(`projects`)},className:`hero-button hero-button-primary`,children:`View My Work`}),(0,b.jsx)(`button`,{onClick:t=>{t.preventDefault(),e(`contact`)},className:`hero-button hero-button-secondary`,children:`Contact Me`})]})]})})})}function Yc({onNavigate:e}){return(0,b.jsx)(qc,{children:(0,b.jsx)(`main`,{children:(0,b.jsx)(Jc,{onNavigate:e})})})}function Xc(){return(0,b.jsx)(`section`,{id:`about`,className:`about-section`,children:(0,b.jsxs)(`div`,{className:`section-inner`,children:[(0,b.jsxs)(`div`,{className:`section-heading my-5`,children:[(0,b.jsx)(`h2`,{children:`About Me`}),(0,b.jsxs)(`p`,{children:[`Hi! I am a passionate developer focusing on modern software development practices. I specialize in building complete backend and logical systems using `,(0,b.jsx)(`strong`,{children:`C#`}),`, using `,(0,b.jsx)(`strong`,{children:`Visual Studio Code`}),` and `,(0,b.jsx)(`strong`,{children:`Visual Studio IDE`}),`, with `,(0,b.jsx)(`strong`,{children:`Microsoft SQL Server`}),` managing data structures.`]}),(0,b.jsx)(`p`,{children:`Outside of programming, I enjoy testing my strategy skills playing chess, diving into online multiplayer games, and watching movies.`})]}),(0,b.jsx)(`div`,{className:`about-grid`,children:[`BCA Student`,`Remote Work Ready`,`Continuous Learner`,`Available for Freelance`].map((e,t)=>(0,b.jsxs)(`div`,{className:`about-item`,children:[(0,b.jsx)(`span`,{className:`about-icon`,children:`✔`}),(0,b.jsx)(`span`,{children:e})]},t))})]})})}function Zc(){return(0,b.jsx)(qc,{children:(0,b.jsx)(`main`,{children:(0,b.jsx)(Xc,{})})})}function Qc({onNavigate:e}){return(0,b.jsx)(`section`,{id:`projects`,className:`projects-section`,children:(0,b.jsxs)(`div`,{className:`section-inner`,children:[(0,b.jsxs)(`div`,{className:`section-heading`,children:[(0,b.jsx)(`h2`,{children:`Featured Projects`}),(0,b.jsx)(`p`,{children:`A selection of terminal applications and software systems I have built.`})]}),(0,b.jsx)(`div`,{className:`project-grid`,children:[{title:`String Analyzer`,description:`An application engineered to process text datasets, analyzing individual character occurrences and string metrics dynamically.`,URL:`https://github.com/Prasoon9336/CharHandling`,tags:[`C#`,`.NET`]},{title:`Mathematical Calculator`,description:`A robust terminal calculator designed to evaluate arithmetic operations with custom control flow logic architectures.`,URL:`https://github.com/Prasoon9336/Calculator`,tags:[`C#`,`.NET`]},{title:`Weather Forecaster`,description:`A console-based weather forecasting tool that retrieves and displays real-time weather data using API integration.`,URL:`https://github.com/Prasoon9336/WeatherForcast`,tags:[`C#`,`.NET`,`API`],apptype:`Webpage Application`},{title:`Dictionary`,description:`A Common React implemented Dictionary Application`,URL:`https://github.com/Prasoon9336/Dictionary`,tags:[`React`,`API`],apptype:`Webpage Application`}].map((t,n)=>(0,b.jsxs)(`article`,{className:`project-card`,children:[(0,b.jsxs)(`div`,{className:`project-card-header`,children:[(0,b.jsx)(`div`,{className:`project-icon`,children:`📁`}),(0,b.jsx)(`div`,{className:`project-links`,children:(0,b.jsx)(`a`,{href:t.URL,target:`_blank`,rel:`noopener noreferrer`,className:`project-link`,children:`View Repo`})})]}),(0,b.jsxs)(`div`,{className:`project-card-body`,children:[(0,b.jsx)(`h3`,{children:t.title}),(0,b.jsx)(`p`,{children:t.description}),(0,b.jsx)(`p`,{className:`project-type`,children:t.apptype||`Console Application`}),(0,b.jsx)(`div`,{className:`project-tags`,children:t.tags.map((e,t)=>(0,b.jsx)(`span`,{className:`project-tag`,children:e},t))})]}),(0,b.jsxs)(`div`,{className:`project-actions`,children:[(0,b.jsx)(`a`,{href:t.URL,target:`_blank`,rel:`noopener noreferrer`,className:`project-button project-button-primary`,children:`Source Code`}),t.apptype===`Webpage Application`&&(0,b.jsx)(`button`,{type:`button`,className:`project-button project-button-secondary`,onClick:()=>e&&e(`weather`),children:`Open App`})]})]},n))})]})})}function $c({onNavigate:e}){return(0,b.jsx)(qc,{children:(0,b.jsx)(`main`,{children:(0,b.jsx)(Qc,{onNavigate:e})})})}function el(){let[e,t]=(0,_.useState)(``),[n,r]=(0,_.useState)({show:!1,type:``,text:``}),[i,a]=(0,_.useState)(null);function o(e){let t=(e||``).toLowerCase();return t.includes(`sunny`)||t.includes(`clear`)?`☀️`:t.includes(`cloud`)?`☁️`:t.includes(`rain`)?`🌧️`:t.includes(`snow`)?`❄️`:t.includes(`thunder`)||t.includes(`storm`)?`⛈️`:t.includes(`mist`)||t.includes(`fog`)?`🌫️`:`🌤️`}async function s(e){let t=`https://api.weatherapi.com/v1/current.json?key=217cb95479854c308ac145316262405&q=${encodeURIComponent(e)}&aqi=yes`;r({show:!0,type:`processing`,text:`Fetching weather for "${e}"...`}),a(null);try{let e=await fetch(t);if(!e.ok)throw Error(`Location not found or API error: ${e.status}`);let n=await e.json();a(n),r({show:!1,type:``,text:``})}catch(e){console.error(`API Error:`,e),r({show:!0,type:`error`,text:`Error: ${e.message}. Please check the location name and try again.`}),a(null)}}return(0,b.jsxs)(`main`,{children:[(0,b.jsx)(`style`,{children:`
      ...
      `}),(0,b.jsx)(`div`,{className:`Weather-section wf-wrapper`,children:(0,b.jsxs)(`div`,{className:`utility-card`,children:[(0,b.jsx)(`h1`,{children:`Weather Forecast`}),(0,b.jsx)(`p`,{className:`description`,children:`Fetching weather information from public API.`}),(0,b.jsxs)(`div`,{className:`input-group`,children:[(0,b.jsx)(`input`,{type:`text`,className:`input`,placeholder:`Enter city name (e.g., London, New York, Tokyo)`,value:e,onChange:e=>t(e.target.value),onKeyPress:t=>{t.key===`Enter`&&s(e)}}),(0,b.jsx)(`button`,{className:`action-btn`,onClick:()=>{e.trim()?s(e.trim()):r({show:!0,type:`error`,text:`Please enter a city name.`})},children:`Get Weather`})]}),(0,b.jsx)(`div`,{id:`logStatus`,className:n.show?n.type:``,style:{display:n.show?`block`:`none`},children:n.text}),i&&(0,b.jsx)(`div`,{className:`weather-data`,children:(0,b.jsxs)(`div`,{className:`weather-card`,children:[(0,b.jsxs)(`h2`,{children:[i.location.name,`, `,i.location.country]}),(0,b.jsxs)(`div`,{className:`condition-info`,children:[(0,b.jsx)(`div`,{className:`condition-icon`,children:o(i.current.condition.text)}),(0,b.jsxs)(`div`,{className:`condition-text`,children:[(0,b.jsx)(`div`,{className:`text`,children:i.current.condition.text}),(0,b.jsxs)(`div`,{className:`temp`,children:[i.current.temp_c,`°C (`,i.current.temp_f,`°F)`]})]})]}),(0,b.jsxs)(`div`,{className:`weather-info`,children:[(0,b.jsxs)(`div`,{className:`info-item`,children:[(0,b.jsx)(`div`,{className:`info-label`,children:`Feels Like`}),(0,b.jsxs)(`div`,{className:`info-value`,children:[i.current.feelslike_c,`°C`]})]}),(0,b.jsxs)(`div`,{className:`info-item`,children:[(0,b.jsx)(`div`,{className:`info-label`,children:`Humidity`}),(0,b.jsxs)(`div`,{className:`info-value`,children:[i.current.humidity,`%`]})]}),(0,b.jsxs)(`div`,{className:`info-item`,children:[(0,b.jsx)(`div`,{className:`info-label`,children:`Wind Speed`}),(0,b.jsxs)(`div`,{className:`info-value`,children:[i.current.wind_kph,` km/h`]})]}),(0,b.jsxs)(`div`,{className:`info-item`,children:[(0,b.jsx)(`div`,{className:`info-label`,children:`Pressure`}),(0,b.jsxs)(`div`,{className:`info-value`,children:[i.current.pressure_mb,` mb`]})]}),(0,b.jsxs)(`div`,{className:`info-item`,children:[(0,b.jsx)(`div`,{className:`info-label`,children:`Visibility`}),(0,b.jsxs)(`div`,{className:`info-value`,children:[i.current.vis_km,` km`]})]}),(0,b.jsxs)(`div`,{className:`info-item`,children:[(0,b.jsx)(`div`,{className:`info-label`,children:`UV Index`}),(0,b.jsx)(`div`,{className:`info-value`,children:i.current.uv})]})]})]})})]})})]})}function tl(){return(0,b.jsx)(qc,{children:(0,b.jsx)(`main`,{children:(0,b.jsx)(el,{})})})}var nl=()=>(0,b.jsxs)(`header`,{className:`px-50 py-20 bg-transparent text-white text-center`,children:[(0,b.jsx)(`h1`,{className:`text-[40px] mb-2.5`,children:`Dictionary`}),(0,b.jsx)(`p`,{className:`text-[16px]`,children:`Lemme help you to find the meaning of your words.....!`})]});function rl({searchWord:e,word:t,setWord:n}){return(0,b.jsx)(`div`,{children:(0,b.jsxs)(`form`,{className:`p-10 gap-9 flex justify-center text-white text-center`,onSubmit:e,children:[(0,b.jsx)(`input`,{className:`p-5 flex-15px border-2 border-transparent text-white focus:outline-0 bg-transparent placeholder-indigo-400 rounded-4xl transition duration-300 ease-in-out hover:bg-indigo-400 hover:placeholder-white`,type:`text`,placeholder:`Enter Word.....`,value:t,onChange:e=>n(e.target.value)}),(0,b.jsx)(`button`,{className:`px-14 flex-5px bg-transparent rounded-4xl transition duration-300 ease-in-out hover:bg-indigo-600 hover:text-white`,type:`submit`,children:`Search!`})]})})}function il(e){let[t,n]=(0,_.useState)(null);return(0,_.useEffect)(()=>{if(!e){n(null);return}fetch(e).then(e=>{if(!e.ok)throw Error(`HTTP error: ${e.status}`);return e.json()}).then(e=>{n(e)}).catch(e=>{console.error(`Fetch error:`,e),n(null)})},[e]),t}function al({data:e}){if(!e||!Array.isArray(e)||e.length===0)return(0,b.jsx)(`div`,{className:`mx-auto mt-8 max-w-3xl rounded-2xl bg-transparent p-8 text-center shadow-lg`,children:(0,b.jsx)(`p`,{className:`text-white`,children:`No Result Found!!!`})});let t=e[0];return(0,b.jsx)(b.Fragment,{children:(0,b.jsxs)(`div`,{className:`mx-auto mt-10 w-[90%] max-w-4xl rounded-2xl bg-transparent p-6 shadow-xl md:p-8`,children:[(0,b.jsx)(`div`,{className:`mb-6 border-b border-gray-200 pb-5`,children:(0,b.jsxs)(`div`,{className:`flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between`,children:[(0,b.jsx)(`h2`,{className:`text-4xl font-bold text-white`,children:t.word}),(0,b.jsx)(`p`,{className:`rounded-full bg-transparent px-4 py-2 text-sm font-medium text-white`,children:t.phonetic})]})}),(0,b.jsx)(`div`,{className:`space-y-8`,children:t.meanings.map((e,t)=>(0,b.jsxs)(`div`,{className:`rounded-xl bg-transparent p-5`,children:[(0,b.jsx)(`h3`,{className:`mb-4 inline-block rounded-full bg-transparent px-4 py-1.5 text-sm font-semibold capitalize text-white`,children:e.partOfSpeech}),(0,b.jsx)(`div`,{className:`space-y-4`,children:e.definitions.map((e,t)=>(0,b.jsx)(`div`,{className:`rounded-lg bg-transparent p-4 shadow-sm`,children:(0,b.jsxs)(`div`,{className:`flex gap-3`,children:[(0,b.jsxs)(`span`,{className:`font-bold text-white`,children:[` `,t+1]}),(0,b.jsx)(`p`,{className:`leading-7 text-white`,children:e.definition})]})},t))})]},t))})]})})}function ol(){let[e,t]=(0,_.useState)(``),[n,r]=(0,_.useState)(``),i=il(n);function a(t){t.preventDefault(),e.trim()&&r(`https://api.dictionaryapi.dev/api/v2/entries/en/${encodeURIComponent(e.trim())}`)}return(0,b.jsx)(`main`,{className:`min-h-screen flex items-center justify-center bg-transparent py-12 px-6`,children:(0,b.jsxs)(`div`,{className:`w-full max-w-3xl bg-transparent rounded-xl p-8 text-center`,children:[(0,b.jsx)(nl,{}),(0,b.jsx)(`div`,{className:`mt-6`,children:(0,b.jsx)(rl,{word:e,setWord:t,searchWord:a})}),(0,b.jsx)(`div`,{className:`mt-6`,children:(0,b.jsx)(al,{data:i})})]})})}function sl(){let[e,t]=(0,_.useState)({name:``,email:``,subject:``,message:``}),[n,r]=(0,_.useState)(``),i=e=>{let{name:n,value:r}=e.target;t(e=>({...e,[n]:r}))};return(0,b.jsx)(`section`,{id:`contact`,className:`contact-section`,children:(0,b.jsx)(`div`,{className:`container py-4 my-5`,children:(0,b.jsx)(`div`,{className:`row justify-content-center`,children:(0,b.jsx)(`div`,{className:`col-lg-8`,children:(0,b.jsxs)(`div`,{className:`contact-content`,children:[(0,b.jsx)(`h2`,{className:`fw-bold text-center mb-3`,children:`Get In Touch`}),(0,b.jsx)(`p`,{className:`text-center text-white mb-5`,children:`I'd love to hear from you! Whether you have a question or just want to say hello, feel free to reach out.`}),(0,b.jsxs)(`form`,{onSubmit:n=>{n.preventDefault(),e.name&&e.email&&e.subject&&e.message?(r(`Message sent successfully!`),t({name:``,email:``,subject:``,message:``}),setTimeout(()=>r(``),3e3)):(r(`Please fill out all fields`),setTimeout(()=>r(``),3e3))},className:`contact-form`,children:[(0,b.jsxs)(`div`,{className:`mb-4`,children:[(0,b.jsx)(`label`,{htmlFor:`name`,className:`form-label`,children:`Name`}),(0,b.jsx)(`input`,{type:`text`,className:`form-control`,id:`name`,name:`name`,value:e.name,onChange:i,placeholder:`Your name`})]}),(0,b.jsxs)(`div`,{className:`mb-4`,children:[(0,b.jsx)(`label`,{htmlFor:`email`,className:`form-label`,children:`Email`}),(0,b.jsx)(`input`,{type:`email`,className:`form-control`,id:`email`,name:`email`,value:e.email,onChange:i,placeholder:`your.email@example.com`})]}),(0,b.jsxs)(`div`,{className:`mb-4`,children:[(0,b.jsx)(`label`,{htmlFor:`subject`,className:`form-label`,children:`Subject`}),(0,b.jsx)(`input`,{type:`text`,className:`form-control`,id:`subject`,name:`subject`,value:e.subject,onChange:i,placeholder:`What is this about?`})]}),(0,b.jsxs)(`div`,{className:`mb-4`,children:[(0,b.jsx)(`label`,{htmlFor:`message`,className:`form-label`,children:`Message`}),(0,b.jsx)(`textarea`,{className:`form-control`,id:`message`,name:`message`,rows:`5`,value:e.message,onChange:i,placeholder:`Your message here...`})]}),n&&(0,b.jsx)(`div`,{className:`alert ${n.includes(`successfully`)?`alert-success`:`alert-warning`} mb-4`,role:`alert`,children:n}),(0,b.jsx)(`button`,{type:`submit`,className:`btn btn-primary btn-lg w-100`,children:`Send Message`})]}),(0,b.jsxs)(`div`,{className:`contact-links mt-5 pt-5 border-top border-secondary text-center`,children:[(0,b.jsx)(`h4`,{className:`fw-bold mb-4`,children:`Or connect with me on`}),(0,b.jsxs)(`div`,{className:`d-flex gap-3 justify-content-center flex-wrap`,children:[(0,b.jsxs)(`a`,{href:`https://github.com/prasoon9336`,target:`_blank`,rel:`noopener noreferrer`,className:`btn btn-outline-primary`,children:[(0,b.jsx)(`i`,{className:`bi bi-github me-2`}),`GitHub`]}),(0,b.jsxs)(`a`,{href:`https://instagram.com/prasoon._.2004/`,target:`_blank`,rel:`noopener noreferrer`,className:`btn btn-outline-info`,children:[(0,b.jsx)(`i`,{className:`bi bi-instagram me-2`}),`Instagram`]}),(0,b.jsxs)(`a`,{href:`mailto:prasoonsrivastava44@gmail.com`,className:`btn btn-outline-light`,children:[(0,b.jsx)(`i`,{className:`bi bi-envelope me-2`}),`Email`]})]})]})]})})})})})}function cl(){return(0,b.jsx)(qc,{children:(0,b.jsx)(`main`,{children:(0,b.jsx)(sl,{})})})}var ll={home:Yc,about:Zc,projects:$c,weather:tl,Dictionary:ol,contact:cl};function ul(){let[e,t]=(0,_.useState)(`home`),n=ll[e]||Yc;return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(`div`,{style:{width:`100%`,height:600,position:`relative`},children:(0,b.jsx)(Kc,{colors:[`#5227FF`,`#FF9FFC`,`#B497CF`],mouseForce:20,cursorSize:70,isViscous:!0,viscous:30,iterationsViscous:32,iterationsPoisson:32,resolution:.5,isBounce:!0,autoDemo:!0,autoSpeed:.5,autoIntensity:2.2,takeoverDuration:.25,autoResumeDelay:3e3,autoRampDuration:.6,color0:`#5227FF`,color1:`#FF9FFC`,color2:`#B497CF`})}),(0,b.jsx)(S,{currentPage:e,onNavigate:t}),(0,b.jsx)(`div`,{className:`scrollable-content`,children:(0,b.jsx)(`div`,{className:`page-content`,children:(0,b.jsx)(n,{onNavigate:t})},e)})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,b.jsx)(_.StrictMode,{children:(0,b.jsx)(ul,{})}));